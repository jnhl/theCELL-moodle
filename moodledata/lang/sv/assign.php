...
$string['duedate_help'] = 'Detta är sluttiden för inlämning. Inlämningar kommer fortfarande vara möjlig efter detta datum men kommer då märkas som sena. För att förhindra inlämning efter ett visst datum sätt inlämningsuppgiftens stoppdatum.';
