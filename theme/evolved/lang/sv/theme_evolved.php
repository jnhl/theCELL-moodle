...
$string['mycoursetitledesc'] = 'Ändra terminologin för länken "Mina kurser" i dropdownmenyn';
$string['mycourses'] = 'Mina Kurser';
$string['myunits'] = 'My Enheter';
$string['mymodules'] = 'My Modules';
$string['myclasses'] = 'Mina Klasser';
$string['allcourses'] = 'Alla Kurser';
$string['allunits'] = 'Alla Enheter';
$string['allmodules'] = 'Alla Moduler';
$string['allclasses'] = 'Alla Klasser';
$string['noenrolments'] = 'Du har inga aktuella registreringar';
