        ...
        <div id="header-nav" class = "clearfix">
            <nav class="header-navbar">
                <ul>
                    ...
                    <li><a href = "<?php echo $CFG->wwwroot;?>/course">Kurser</a></br></br><a href="<?php echo $CFG->wwwroot;?>/report/mygrades/">Översikt</a></li>
                    <li><a href = "<?php echo $CFG->wwwroot;?>/course/view.php?id=8&section=0&sesskey=<?php echo $USER->sesskey;?>&edit=on">Rutiner</a></li>
                    <li><a href = "<?php echo $CFG->wwwroot;?>/local/sharedresources/index.php?course=1">Material</a></li>
