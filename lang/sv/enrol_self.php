...
/**
 * Strings for component 'enrol_self', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_self
...
$string['enrolperiod_desc'] = 'Förinställd tid (i sekunder) som användaren är kopplad till kursen, med start från då användaren läggs till. Om denna är satt till 0 är tiden obegränsad.';
