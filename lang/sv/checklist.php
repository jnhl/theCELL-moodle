...
/**
 * Strings for component 'checklist', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   checklist
...
$string['addcomments'] = 'Lägg till kommentar';
$string['additem'] = 'Lägg till';
$string['additemalt'] = 'Lägg till nytt element i lista';
$string['additemhere'] = 'Lägg in nytt element efter detta element';
$string['addownitems'] = 'Lägg in egna element';
$string['addownitems-stop'] = 'Avsluta att lägga in egna element';
$string['allowmodulelinks'] = 'Tillåt modul länkar';
$string['anygrade'] = 'Alla';
$string['autopopulate'] = 'Visa kurselement i listan';
$string['autopopulate_help'] = 'Detta kommer automatiskt att lägga till en lista över alla befintliga resurser och aktiviteter av den aktuella kursen i checklistan. Den här listan kommer att uppdateras med ändringar i kursen, när du väljer "Aktivera redigering" för checklistan.  Elementer kan döljas från listan, genom att klicka på "Dölj"-ikonen bredvid dem. För att ta bort de automatiska objekt från listan, ändra det här alternativet till "Nej" och klicka sedan på "Ta bort"på" Redigera "-sidan.';
$string['autoupdate'] = 'Check-off när modul är avslutat';
$string['autoupdate_help'] = 'Funktionen kommer automatiskt att markera elementer i din checklista när den relaterade aktivitet i kursen är genomförd. När en aktivitet är "genomförd" kan variera mellan olika aktiviteter. Om i Moodle 2.0 färdigställande spårning är påslagen i en kurs, som kommer detta att användas för att markera relaterade element i checklistan i listan. För information om exakt vad som orsakar att ett element markeras som "komplett", be administratören att titta i filen "mod / checklista / autoupdate.php".
OBS: det kan ta upp till 60 sekunder för att en students genomförda markering syns i deras checklista.';
$string['autoupdatenote'] = 'Det är endast studentens markeringar som blir uppdaterade - inga uppdateringer för checklister som endast lärare använder visas';
$string['autoupdatewarning_both'] = 'Det finns elementer i denna lista som kommer att uppdateras automatiskt (som t.ex. när studenter slutför en relaterad aktivitet). Men eftersom detta är en "student och lärare" Checklista kommer  förloppsindikatorerna inte att uppdateras förrän en lärare genomför de givna markeringarna.';
$string['autoupdatewarning_student'] = 'Det finns elementer på denna lista som kommer att uppdateras automatiskt (som t.ex. när studenter genomför en relaterad aktivitet).';
$string['autoupdatewarning_teacher'] = 'Automatiskt uppdatering har aktiverats för den här checklisten, men automatiska uppdateringar kommer inte att visas eftersom endast "lärarnas" markeringar visas';
$string['calendardescription'] = 'Detta element blev lagt till genom en checklist';
...
$string['checklistintro'] = 'Introduktion';
$string['checklist:preview'] = 'Innehåll checklist';
...
$string['checks'] = 'Lägg till markering';
$string['comments'] = 'Kommentarer';
$string['completionpercent'] = 'Andel av element som ska vara markerade/slutförda';
$string['completionpercentgroup'] = 'Kräv markeringar';
...
$string['editchecks'] = 'Redigera markeringar/checkbox';
$string['editdatesstart'] = 'Redigera datum';
$string['editdatesstop'] = 'Avsluta redigering datum';
$string['edititem'] = 'Redigera detta element';
$string['emailoncomplete'] = 'Skicka epost till lärare när checklist är komplett/slutförd';
$string['emailoncompletebody'] = 'Användare har slutfört checklistan. Visa checklista här';
$string['emailoncompletebodyown'] = 'Du har slutfört checklista &quot;{$a->checklist}&quot; i kursen &quot;{$a->coursename}&quot; Se checklistan här:';
$string['emailoncomplete_help'] = 'När en checklista är klar/genomförd/avslutad skickas ett meddelande till alla lärare i kursen. En administratör kan kontrollera vem som får detta e-post med möjligheten "mod: checklista / emailoncomplete \'-. Även "lärare" och icke-redigerinlärarna har möjlighet till detta.';
...
$string['headingitem'] = 'Detta element är en Överskrift. Element innehåller ingen checkbox som kan markeras';
...
$string['percentcompleteall'] = 'Alla element';
$string['pluginadministration'] = 'Checklista administration';
$string['pluginname'] = 'Checklista';
$string['preview'] = 'Innehåll Checklista';
$string['progress'] = 'Visa/ Editera framsteg/progress';
$string['removeauto'] = 'Ta bort kurs element';
$string['report'] = 'Visa/ Editera framsteg/progress';
...
$string['showprogressbars'] = 'Översiktsvy för framsteg/progress';
...
$string['teachermarkno'] = 'Lärare har markerat att du inte har slutfört detta element';
$string['teachermarkundecided'] = 'Lärare har ännu inte markerat detta element';
$string['teachermarkyes'] = 'Lärare har markerat att du har slutfört detta element';
$string['teachernoteditcheck'] = 'Endast student';
$string['teacheroverwritecheck'] = 'Endast lärare';
$string['theme'] = 'Checklist display tema';
$string['togglecolumn'] = 'Markera kolumn';
$string['toggledates'] = 'Visa datum för senaste ändring';
...
$string['useritemsallowed'] = 'Användare kan själv lägga till element';
...
$string['viewsinglereport'] = 'Visa/Editera framsteg/progress för den här användare';
$string['viewsingleupdate'] = 'Uppdatera framsteg/progress för den här användare';
