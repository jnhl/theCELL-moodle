...
/**
 * Strings for component 'search', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   search
...
$string['checkdbadvice'] = 'Kontrollera Din databas för att se om det finns några problem';
$string['checkdir'] = 'Kontrollera dir';
$string['checkdiradvice'] = 'Ta reda på om datakatalogen finns och är skrivbar';
$string['commenton'] = 'Kommentar till';
$string['createanindex'] = 'Skapa ett index';
$string['createdon'] = 'Skapad på';
