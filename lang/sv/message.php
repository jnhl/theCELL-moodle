...
/**
 * Strings for component 'message', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   message
...
$string['cannotsavemessageprefs'] = 'Det gick inte att spara preferenserna för meddelanden för användare';
...
$string['disableall'] = 'Stäng tills vidare av alla notifikationer (utom de obligatoriska).';
$string['disableall_help'] = 'Inaktivera tillfälligt alla meddelanden utom de som är markerade som &quot;tvingande&quot; av administratören';
...
$string['managecontacts'] = 'Hantera kontakter';
...
$string['mostrecentconversations'] = 'Senaste konversationerna';
$string['mostrecentnotifications'] = 'Senaste notifikationerna';
...
$string['unreadnewnotification'] = 'Olästa meddelanden - notifikation';
$string['unreadnewnotifications'] = 'Nya notifikationer ({$a})';
