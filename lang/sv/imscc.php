...
/**
 * Strings for component 'imscc', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   imscc
...
$string['cc2moodle_valid_schema'] = 'Schemat är giltigt!';
$string['cc_import_req_dom'] = 'FEL: Importen av Common Cartridge-paketetet kräver DOM tillägg.';
$string['cc_import_req_libxml'] = 'FEL: Importen av Common Cartridge-paketetet kräver LIBXML-tillägg';
