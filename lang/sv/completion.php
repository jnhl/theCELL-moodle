...
/**
 * Strings for component 'completion', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   completion
...
$string['addcourseprerequisite'] = 'Lägg till kurskriterium.';
...
$string['completionusegrade_desc'] = 'Kursdeltagare måste ha uppnått ett resultat/betyg för att aktiviteten ska anses fullföljd';
...
$string['courseprerequisites'] = 'Förkunskapskrav för kurs';
...
$string['deletecoursecompletiondata'] = 'Ta bort data om kursens fullföljande';
...
$string['prerequisites'] = 'Förkunskapskrav';
$string['prerequisitescompleted'] = 'Förkunskapskrav genomförda';
