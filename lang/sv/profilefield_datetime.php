...
/**
 * Strings for component 'profilefield_datetime', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['currentdatedefault'] = 'Bocka för för att använda nuvarande datum som förvalt';
$string['defaultdate'] = 'Förvalt datum';
