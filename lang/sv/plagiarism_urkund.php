...
/**
 * Strings for component 'plagiarism_urkund', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['studentdisclosuredefault'] = 'Alla filer som laddas upp kommer att lämnas in för plagiarismsökning med URKUND, om du vill förhindra att ditt dokument används som källa för analys utanför denna webbplats av andra organisationer kan du använda opt-out länken som visas efter att rapporten har genererats.';
$string['studentdisclosure_help'] = 'Denna text kommer att visas för alla elever på filuppladdningssidan.';
$string['studentemailcontent'] = 'Filen du skickade in till {$a->modulename} i {$a->coursename} har nu granskats av antiplagiarismverktyget URKUND. {$a->modulelink} Om du vill förhindra att ditt dokument används som en källa för analys utanför denna webbplats av andra organisationer kan du använda denna länk för att opt-out:. {$a->optoutlink}';
...
$string['urkund_show_student_score'] = 'Visa likhetsresultat för elev';
