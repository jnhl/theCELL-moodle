...
/**
 * Strings for component 'editor_tinymce', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['common:browseimage'] = 'Hitta eller ladda upp en bild...';
$string['common:browsemedia'] = 'Hitta eller ladda upp ett ljud, video eller en applet...';
...
$string['dragmath:dragmath_desc'] = 'Infoga ekvation';
$string['dragmath:dragmath_javaneeded'] = 'För att använda den här sidan behöver Du en Java-aktiverad webbläsare. Ladda ner det senaste plugin-programmet för Java från {$a}.';
$string['dragmath:dragmath_title'] = 'Redigerare (för ekvationer) från DragMath';
...
$string['media_dlg:filename'] = 'Filnamn';
...
$string['paste:plaintext_mode_sticky'] = '\'Klistra in\' är f n i läget för ren text. Klicka igen för att växla tillbaka till standardläget för \'Klistra in\'. Efter det att Du har klistrat in någonting kommer Du att komma tillbaka till standardläget för \'Klistra in\'.';
