...
/**
 * Strings for component 'block_tags', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   block_tags
...
$string['alltags1'] = 'alla taggar';
$string['alltags2'] = 'Visa alla taggar (användarprofil, bloggar och kurstaggar)';
$string['arrowtitle'] = 'Klicka här för att mata in den föreslagna texten (grå bokstäver)';
$string['communitytags'] = 'Taggar (gemenskap):';
$string['communitytags1'] = 'taggar (gemenskap)';
$string['communitytags2'] = 'Visa alla kurstaggar som skapats av användare';
$string['coursetags'] = 'Kurstaggar:';
$string['coursetags1'] = 'kurstaggar';
$string['coursetags2'] = 'Visa taggarna för den här kursen';
