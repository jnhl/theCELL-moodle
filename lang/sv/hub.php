...
/**
 * Strings for component 'hub', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   hub
...
$string['moodleorgregistrationdetail'] = 'Huvudhuben för gemenskapen på Moodle.org kallas MOOCH. Genom att registrera din hub på MOOCH bidrar du till statistiken över den världsomspännande Moodle gemenskapen. Du kan även ansluta dig till en mindre e-postlista som fer tidiga meddelanden om säkerhetsuppdateringar och andra nya uppdateringa från Moodle.';
...
$string['registeredon'] = 'Registrerad till';
$string['registeredsites'] = 'Registrerade webbplatser';
$string['registeron'] = 'Registrera din webbplats';
$string['registeronmoodleorg'] = 'Registrera på Moodle.org (MOOCH)';
$string['registeronspecifichub'] = 'Registrera på en specifik hub';
...
$string['specifichub'] = 'Specifik hub';
