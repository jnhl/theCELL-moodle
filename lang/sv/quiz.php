...
/**
 * Strings for component 'quiz', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz
...
$string['addingdescription'] = 'Lägger till en beskrivning';
...
$string['attemptsallowedn'] = 'Tillåtna försök: {$a}';
...
$string['browsersecurity_help'] = 'Om "Helskärms-popup med viss Javascript-säkerhet" väljs, startar testen bara om studenten tillåter Javascript i sin webbläsare. Testen öppnas i ett webbläsarfönster som täcker hela skärmen och saknar navigationskontroller. (De som gör testen hindras så mycket som möjligt från att använda kopiera/klistra in.';
...
$string['changessavedwitherrors'] = 'Det uppstod några fel i sb m att ändringarna i betygssättningen skulle sparas';
...
$string['configdecimaldigits'] = 'Antal decimaler som ska visas när betyget visas.';
...
$string['configdelay1'] = 'Om du anger en tidsfördröjning måste eleverna vänta angiven tid efter första försöket innan de kan försöka genomföra testet igen.';
$string['configdelay1st2nd'] = 'Om du anger en tid här kan eleven inte starta sitt andra försök förrän angiven tid passerat sedan första försöket.';
$string['configdelay2'] = 'Om du anger en tidsfördröjning här måste en elev vänta angiven tid innan den kan göra sitt tredje eller senare försök.';
$string['configdelaylater'] = 'Om du anger en tidsfördröjning här kan eleven inte starta sit tredje, fjärde.... försök förrän angiven tid förflutit sedan slutet på elevens föregående försök.';
$string['configeachattemptbuildsonthelast'] = 'Om flerfaldiga försök tillåts så kommer varje nytt försök att innehålla reslutaten från föregående försök.';
$string['configgrademethod'] = 'Om flerfaldiga försök tillåts vilken metod böe användas för att beräkna elevens slutpoäng för testet.';
$string['configintro'] = 'De värden du anger här definierar de förvalda värden som används i inställningsformuläret när du skapar en ny test. Du kan även konfigurera vilka testinställningar som ska anses vara avancerade.';
$string['configmaximumgrade'] = 'Den förvalda skala som test-betyg utgår från.';
$string['confignewpageevery'] = 'När du lägger till frågor till testet kommer sidbrytningar automatiskt att infogas enligt den inställning du gör här.';
$string['configpenaltyscheme'] = 'Avdrag gjorda för varje felaktigt svar i anpassande läge';
$string['configpopup'] = 'Tvinga försöket att öppnas i ett popup-fönster och använd JavaScript-funktioner för att försöka motverka kopiera och klistra in och liknande under testförsöket.';
...
$string['configreviewoptions'] = 'Dessa inställningar kontrollerar vilken information användare kan se när de granskar ett testförsök eller en testrapport.';
...
$string['decimalplacesquestion_help'] = 'Denna inställning anger antalet siffror som visas efter decimapunkten vid visning av poäng för enskild fråga.';
...
$string['delay1st2nd'] = 'Tvingande fördröjning mellan första och andra försöket';
...
$string['delaylater'] = 'Tvingande fördröjning mellan senare försök';
...
$string['editingdescription'] = 'Redigerar en beskrivning';
$string['editingessay'] = 'Redigerar essäfråga';
$string['editingmatch'] = 'Redigerar en para-ihop-fråga';
$string['editingmultianswer'] = 'Redigerar en fråga med inbäddade svar';
$string['editingmultichoice'] = 'Redigerar en flervalsfråga';
$string['editingnumerical'] = 'Redigerar en numerisk fråga';
...
$string['editingrandom'] = 'Redigerar en slumpfråga';
$string['editingrandomsamatch'] = 'Redigerar en para-ihop-fråga med framslumpade kortsvars-frågor';
$string['editingrqp'] = '{$a}:  redigererar en fråga';
$string['editingshortanswer'] = 'Redigerar en kortsvars-fråga';
...
$string['event6'] = 'Avsluta&betyg/omdöme';
...
$string['generalfeedback_help'] = 'Allmän återkoppling är text som visas efter att en fråga har besvarats. Till skillnad från återkoppling för specifik fråga som beror på avgivet svar, så visas alltid samma allmänna återkoppling.';
...
$string['import_help'] = 'Denna funktion låter dig importera frågor från externa textfiler.

Om din fil innehåller icke-ascii tecken måste den använda teckenkodning UTF-8. Var särskilt försiktig med filer som skapats med Microsoft Officeprogram då dessa vanligtvis använder en speciell teckenkodning vilken inte kommer att hanteras korrekt.

Format för inport och export är instricksmoduler. Andra möjliga format kan finnas tillgängliga i databasen för moduler och insticksmoduler (plugins).';
...
$string['importparseerror'] = 'Fel hittades vid parsning av importfilen. Inga frågor har importerats. Försök igen genom att ställa in "Avbryt vid fel" till "Nej"';
...
$string['itemanal'] = 'Analys av svarsreaktioner på komponenter i test';
...
$string['modulename_help'] = 'Testmodulen låter läraren skapa och designa tester bestående av flervals-, sant/falskt-, matchningsfrågor och andra frågetyper. Varje försök blir automatiskt poängsatt och läraren kan välja om återkoppling och rätta svar ska visas eller inte.';
$string['modulenameplural'] = 'Test';
$string['moveselectedonpage'] = 'Flytta de valda frågorna till sidan: {$a}';
$string['moveto'] = 'Flytta till >>';
$string['multianswer'] = 'Inbäddade svar (lucka)';
...
$string['nogradewarning'] = 'Detta test är inte poängsatt så du kan inte ange allmän återkoppling som varierar med poäng.';
...
$string['noquestionsnotinuse'] = 'Denna slumpvis valda fråga används inte eftersom dess kategori är tom.';
...
$string['orderandpaging_help'] = 'Siffrorna 10, 20, 30, ... motstående respektive fråga visar ordningen på frågorna. Numreringen ökar i steg om 10 för att ge utrymme för ytterligare frågor att infogas. För att ordna frågorna på nytt ändra deras nummer och klicka sedan på knappen "Ordna frågor".';
...
$string['overallfeedback_help'] = 'Övergripande återkoppling är text som visas efter att ett test har genomförts. Genom att dessutom ange poänggränser (som procenttal eller som ett antal), kan texten varieras beroende på antalet erhållna poäng.';
...
$string['popupwithjavascriptsupport'] = 'Popupfönster med helskärm och  JavaScript med visst säkerhetsskydd.';
$string['preprocesserror'] = 'Fel uppstod vid förbehandlling!';
...
$string['questionsperpageselected'] = 'Inställningar för antal frågor per sida är för närvarande gjorda och därför är pagineringskontrollen låst. Du kan ändra detta här {$a}.';
...
$string['randomsamatch'] = 'Matchning av framslumpade kortsvars-frågor';
...
$string['requiresafeexambrowser'] = 'Gör det obligatoriskt att använda en webbläsare som möjliggör ett säkert genomförande av test/prov/examinationer osv.';
...
$string['reviewoptionsheading_help'] = 'Dessa inställningar avgör vilken information elever kan se när de granskar ett genomfört test eller ser på testrapporten.

"Omedelbart efter försöket" innebär inom två minuter sedan testet avslutades. "Senare, medan testet fortfarande är öppet" innebär ännu senare men för testets stängningsdatum. "Efter att testet är stängt" innebär efter testets stängningsdatum. Om testet inte har något stängningsdatum uppnås detta tillstånd aldrig.';
...
$string['showblocks_help'] = 'Om detta sätts till ja visas normala block under testets genomföranden';
...
$string['showuserpicture_help'] = 'Om aktiverat visas elevens namn och bild på skärmen under försöket samt på granskningsvyn för att underlätta kontroll av att eleven är inloggad som sig själv i ett övervakat test';
...
$string['shufflequestionsselected'] = 'Slumpmässig ordning har aktiverats varför vissa inställningar för sidor inte är tillgängliga. För att ändra inställning för slumpmässig ordning {$a}.';
...
$string['top'] = 'Topp';
$string['totalpointsx'] = 'Sammanfattning av betyg/omdömen: {$a}';
