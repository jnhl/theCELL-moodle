...
/**
 * Strings for component 'feedback', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   feedback
...
$string['emailnotification_help'] = 'Om aktiverad mottager alla lärare i kursen e-post om att ett nytt svar har lagts in.';
...
$string['url_for_continue_help'] = 'När en enkät är besvarat är det som standard inställt att knappen "Fortsätt" leder en till kursens startsida. Du kan definiera här ett annat mål/länk för  knappen "Fortsät".';
