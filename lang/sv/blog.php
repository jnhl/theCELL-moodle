...
/**
 * Strings for component 'blog', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   blog
...
$string['cannotviewcourseblog'] = 'Du har inte rättighet att läsa bloggar i den här kursen';
$string['cannotviewcourseorgroupblog'] = 'Du har inte rättighet att läsa bloggar i den här kursen/gruppen';
$string['cannotviewsiteblog'] = 'Du har inte rättighet att läsa alla bloggar';
$string['cannotviewuserblog'] = 'Du har inte rättighet att läsa användares bloggar';
...
$string['courseblogdisable'] = 'Kursbloggar har inte aktiverats';
...
$string['disableblogs'] = 'Inaktivera bloggfunktionen helt';
