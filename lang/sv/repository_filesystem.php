...
/**
 * Strings for component 'repository_filesystem', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['filesystem:view'] = 'Visa arkiv för filsystem';
$string['information'] = 'Dessa mappar ligger inom <b>{$a}</b> katalogen.';
$string['invalidpath'] = 'Felaktig sökväg till rotkatalogen';
$string['nosubdir'] = 'Du måste skapa minst en katalog inuti <b>{$a}</b> så du kan välja den här.';
