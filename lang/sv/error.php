...
/**
 * Strings for component 'error', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   error
...
$string['cannotaddrss'] = 'Du har inte rättigheter att lägga till RSS-utmatningar.';
...
$string['cannotcreategroup'] = 'Fel uppstod då gruppen skulle skapas.';
...
$string['cannotdeletedir'] = 'Kan inte radera ({$a})';
$string['cannotdeletefile'] = 'Det går inte att ta bort den här filen';
$string['cannotdeleterole'] = 'Kan inte radera, på grund av {$a}';
...
$string['cannoteditpostorblog'] = 'Du har inte rättigheter att skapa eller ändra bloggar.';
...
$string['cannotgetdata'] = 'Kan inte hämta data';
...
$string['cannotopenforwrit'] = 'Kunde inte öppna för att skriva: {$a}';
$string['cannotopentemplate'] = 'Kunde inte öppna mallfilen ({$a})';
...
$string['cannotresetthisrole'] = 'Kunde inte återställa rollen.';
...
$string['cannotsavecomment'] = 'Kunde inte spara kommentaren';
$string['cannotsavedata'] = 'Kunde inte spara data';
$string['cannotsavefile'] = 'Kunde inte spara filen "{$a}"!';
...
$string['cannotupdaterss'] = 'Kunde inte uppdatera RSS';
...
$string['cannotuseadminadminorteacher'] = 'Du måste vara administratör eller lärare för att se den här sidan.';
$string['cannotusepage'] = 'Bara administratörer och lärare kan se den här sidan.';
...
$string['duplicaterolename'] = 'Det finns redan en roll med det namnet!';
$string['duplicateroleshortname'] = 'Det finns redan en roll med det kortnamnet!';
...
$string['errorcreatingrole'] = 'Fel uppstod då rollen skulle skapas.';
...
$string['groupusernotmember'] = 'Användaren är inte medlem i den här gruppen.';
...
$string['idnumbertaken'] = 'ID-numret används redan för en annan kurs';
...
$string['nopermissiontoupdatecalendar'] = 'Tyvärr, men du har för närvarande inte behörighet att uppdatera kalenderhändelse';
