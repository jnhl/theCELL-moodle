...
/**
 * Strings for component 'admin', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   admin
...
$string['configallowthemechangeonurl'] = 'Om detta är aktiverat så kan Du ändra tema genom att lägga till theme={themename} till vilken Moodle url som helst.';
...
$string['configjabberusername'] = 'Det användarnamn Du ska använda när Du kopplar upp Dig mot jabber-servern';
...
$string['confignavshowallcourses'] = 'Genom att ställa in detta säkerställer Du att alla kurser på webbplatsen alltid visas i navigationen.';
...
$string['dbtest'] = 'Funktionstest av DB';
...
$string['excludeoldflashclients'] = 'Nödvändig version av Flash-spelare';
...
$string['extrauserselectorfields'] = 'När Du väljer användare, sök och visa';
...
$string['invalidlangpack'] = 'För att redigera det här språkpaketet måste du lägga det i en  mapp för språk. ';
...
$string['uupasswordcron'] = 'Skapad i cron';
...
$string['uuusernametemplate'] = 'Mall för användarnamn';
