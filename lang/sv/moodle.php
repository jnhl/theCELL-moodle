...
/**
 * Strings for component 'moodle', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   moodle
...
$string['activities_help'] = 'Aktiviteter, såsom forum, frågesporter och wikis, gör det möjligt att lägga till interaktivt innehåll till kursen.';
...
$string['adminhelphealthcenter'] = 'Automatisk upptäckt av problem på webbplatsen.';
...
$string['again'] = 'Igen';
$string['aimid'] = 'AIM ID';
$string['ajaxno'] = 'Nej: använd grundläggande egenskaper för webben.';
$string['ajaxuse'] = 'AJAX och Javascript';
$string['ajaxyes'] = 'Ja: använd avancerade egenskaper för webben.';
$string['all'] = 'Alla';
...
$string['category_help'] = '<p>Din administratör av Moodle kan ha satt upp
...
$string['coursefileswarning_help'] = 'I Moodle version 2.0 och senare används inte kursfiler längre. Använd istället så mycket länkar till extern förvaring som möjligt (som tex egna webbplatser utanför Moodle).';
...
$string['coursehelpforce'] = 'Framtvinga kursens gruppläge till alla aktiviteterna i kursen';
...
$string['coursehelpnewsitemsnumber'] = 'Anger det antal aktuella nyheter som ska visas i blocket för nyheter nere på höger sida på kursens ingångssida, <br /> (0 innebär att blocket inte kommer att visas alls)';
$string['coursehelpnumberweeks'] = 'Det antal veckor/delämnen som ska visas på kursens ingångssida.';
...
$string['courselegacyfiles_help'] = 'Funktionen kursfiler ger viss bakåtkompatiblitet med Moodle 1.9 och tidigare. Alla filer i denna arkivtyp är alltid åtkomliga för alla deltagare i kursen (oavsett om du länkar till filerna eller inte) och det finns inget sätt att veta var någon av dessa filer används i Moodle.

Om du använder denna arkivtyp för att lagra kursfiler kan du utsätta dig för ett antal säkerhets- och integritetsproblem. Du kan även råka ut för att filer saknas i säkerhetskopior och kursimporter samt vid varje tillfälle som innehållet delas ut eller återanvänds. Det rekommenderas därför att du inte använder denna arkivtyp såvida du inte har god kunskap om vad du gör.

Länken nedan ger mer information om allt detta och kommer visa dig några bättre sätt att hantera filer i Moodle 2.';
...
$string['courserequestsuccess'] = 'Din ansökan om en kurs har sparats framgångsrikt. Du kan förvänta Dig att det kommer ett e-postmeddelande med besked inom kort.';
...
$string['coursesummary_help'] = 'Kurssammafattningen visas i listan över kurser. En kurssökning söker i kurssammanfattningarna samt i kursnamnen.';
...
Du kan gå till följande sida för att förlänga deras registrering: {$a->extendurl}';
$string['expirynotifystudents'] = 'Meddela studenter/elever/deltagare/lärande';
$string['expirynotifystudentsemail'] = 'Käre/a {$a->studentstr}::
...
$string['expirynotifystudents_help'] = 'Om en period för registrering har angetts då kan Du välja om även studenter/elever/deltagare/lärande ska meddelas via e-post om att tiden håller på att gå ut.';
...
$string['flashlinkmessage'] = 'Var snäll och uppgradera Din Flash-spelare nu:';
$string['flashupgrademessage'] = 'Om Du vill visa detta innehåll så måste Du uppgradera Din Flash-spelare.

Det kan hända att Du måste logga ut och logga in igen efter en uppgradering.';
...
$string['forcepasswordchangecheckfull'] = 'Är Du helt säker på att Du vill framtvinga en ändring av lösenordet till {$a}?';
$string['forcepasswordchange_help'] = 'Om du kryssar för i kryssrutan måste användaren byta lösenord vid nästa inloggning';
$string['forcepasswordchangenot'] = 'Det gick inte att framtvinga en ändring av lösenordet till {$a}.';
...
$string['frontpagedescription'] = 'Beskrivning av ingångssidan';
$string['frontpagedescriptionhelp'] = 'Den här beskrivningen av webbplatsen kommer att visas på ingångssidan (första/hem).';
...
$string['fullnamecourse_help'] = 'Hela kursnamnet visas längst upp på varje sida i kursen och i listan över kurser.';
...
$string['gdneed'] = 'GD måste vara installerat för att Du ska kunna se denna bild.';
...
$string['healthcenter'] = 'Hälsocentralen';
...
$string['hideshowblocks'] = 'Dölj eller visa block';
$string['hits'] = 'Besök';
...
$string['htmleditor'] = 'Använd Richtext HTML-redigeraren (IE endast, 5.5 eller senare)';
...
$string['idnumbermod_help'] = '<p>Genom att ange ett ID-nummer så kan Du identifiera en aktivitet med tanke på hur betygen ska beräknas.
Om aktiviteten inte ingår i betygsunderlaget så behöver Du inte skriva in något i fältet för ID-nummer.
<p> ID-numret kan även anges på sidan för att beräkna betyg i betygskatalogen. Du kan dock bara redigera det på den sida där Du uppdaterar aktiviteten.</p>';
...
$string['includecoursefiles'] = 'Ta med alla kursfiler';
$string['includecourseusers'] = 'Ta med alla lärande i kursen';
$string['included'] = 'Ingår';
$string['includelogentries'] = 'Ta med loggar';
$string['includemodules'] = 'Ta med moduler';
$string['includemoduleuserdata'] = 'Ta med användardata för modulen';
$string['includeneededusers'] = 'Ta med \'nödvändiga\' användare';
$string['includenoneusers'] = 'Ta med inte med användare';
...
$string['interestslist_help'] = 'Ange dina intresseområden separerade med kommatecken. Dina intresseområden kommer att visas på din profil som taggar.';
...
$string['local'] = 'Lokal';
$string['localplugindeleteconfirm'] = 'Du är på väg att ta bort den lokala plugin \'{$ a} ". Detta kommer ta bort allt i databasen som har  med denna plugin att göra. Är du SÄKER på att du vill fortsätta?';
$string['localplugins'] = 'Lokala plugin-program';
$string['localpluginsmanage'] = 'Administrera lokala plugin-program';
...
$string['makethismyhome'] = 'Gör detta till min standardstartsida';
...
$string['matchingsearchandrole'] = 'Matchning av \'{$a->search}\' och {$a->role}';
...
$string['messageprovider:backup'] = 'Meddelanden om säkerhetskopior';
$string['messageprovider:courserequestapproved'] = 'Notifikation om godkännande av begäran om ny kurs';
$string['messageprovider:courserequested'] = 'Notifikation om begäran om ny kurs';
$string['messageprovider:courserequestrejected'] = 'Notifikation om avslagen begäran om ny kurs';
$string['messageprovider:errors'] = 'Viktiga problem med webbplatsen';
...
$string['messageprovider:instantmessage_help'] = 'Denna sektion konfigurerar vad som händer med meddelanden som skickas direkt till dig från andra användare på denna webbplats.';
$string['messageprovider:notices'] = 'Meddelanden om mindre problem';
$string['messageprovider:notices_help'] = 'Dessa är notiser som en administratör kan vara intresserad av att se.';
$string['messageselect'] = 'Markera den här användaren som mottagare av e-postmeddelanden.';
$string['messageselectadd'] = 'Lägg till/skicka meddelande';
...
$string['missingstrings'] = 'Leta efter ej översatta ord och fraser ';
...
$string['moduledeletefiles'] = 'Alla data som är kopplad till modulen \'{$a->module}\' har tagits bort från databasen. För att fullfölja borttagandet(och hindra modulen från att återinstallera sig själv) så bör Du nu ta bort den här katalogen från Din server: {$a->directory}';
...
$string['move'] = 'Flytta';
$string['movecategorycontentto'] = 'Flytta in till';
...
$string['myfilesmanage'] = 'Administrera mina privata filer';
$string['myhome'] = 'Min egen sida';
...
$string['order'] = 'Order';
$string['orphanedactivities'] = 'Föräldralösa aktiviteter';
$string['other'] = 'Annat';
...
$string['pageshouldredirect'] = 'Denna sida ska automatiskt skicka vidare till en annan sida. Om det inte sker, var god klicka på länken nedan.';
...
$string['pleaseusesearch'] = 'Var god använd sökfunktionen';
$string['plugin'] = 'Plugin';
$string['plugincheck'] = 'Kontroll av plugins';
$string['pluginchecknotice'] = 'De följande tabellerna visar de moduler, block och filter som har upptäckts i din nuvarande Moodle-installation;
De visar på vilka plugins som är standard och vilka som inte är det. Alla icke-standard plugins bör kontrolleras och uppgraderas till sina senaste versioner innan du fortsätter med den här uppgraderingen av Moodle.';
...
$string['profilenotshown'] = 'Profilen visas inte förrän personen är kopplad till minst en kurs.';
...
$string['resources_help'] = 'Resurstyper möjliggör att webbinnehåll av nästan vilken typ som helst kan infogas i kursen.';
...
$string['restrictmodules'] = 'Begränsa användning av aktivitetsmoduler?';
...
$string['rolerenaming_help'] = 'Denna inställning tillåter att visade namn för roller som används i kursen att kunna ändras. Endast visningsnamnen för roller ändras - inga rättigheter för roller påverkas. Nya namn på roller visas på deltagarlistor och andra ställen i kursen. Om rollen som fått ändrat namn är en roll som administratören har valt som kursskapare kommer det nya rollnamnet även att visas som en del av kurslistningen.';
$string['roles'] = 'Roller';
$string['rss'] = 'RSS';
...
$string['screenreaderuse_help'] = 'Om satt till ja kommer ett mer tillgängligt gränssnitt att vara tillgängligt på olika ställen såsom direktsamtal.';
...
$string['search_help'] = 'För grundläggande sökning av ett eller flera ord varsomhelst i texten, bara skriv orden separerade med mellanslag. Alla ord längre än två tecken används.';
...
$string['selectnos'] = 'Markera alla som \'nej\'';
...
$string['shortnameuser'] = 'Användarens kortnamn';
...
$string['showtopicfromothers'] = 'Visa ämne';
$string['showweekfromothers'] = 'Visa vecka';
$string['since'] = 'Sedan';
...
$string['toomanyusersmatchsearch'] = 'För många användare ({$a->count}) matchar \'{$a->search}';
$string['toomanyuserstoshow'] = 'För många användare ({$a}) att visa';
...
$string['uploadnotempdir'] = 'Det saknas en tillfällig mapp';
...
$string['useforlegacytheme'] = 'Använd för äldre webbläsare';
$string['useformaintheme'] = 'Använd för moderna webbläsare';
...
$string['userdescription_help'] = 'Denna box möjliggör för dig att skriva en text om dig själv vilken sedan visas för andra användare på din profilsida.';
...
$string['userselectorautoselectunique'] = 'Om endast en användare hittas, markera den automatiskt';
$string['userselectorpreserveselected'] = 'Behåll markerade användare, även om de inte längre matchar sökningen';
...
$string['userviewingsettings'] = 'Inställningar för profilen för {$a}';
$string['userzones'] = 'Användar-zoner';
$string['usingexistingcourse'] = 'Använder befintlig kurs.';
$string['valuealreadyused'] = 'Detta värde har redan används.';
...
$string['withselectedusers_help'] = '* Sänd meddelande - För att sända ett meddelande till en eller flera deltagare
* Lägg till ny notering - För att lägga till en ny notering till vald deltagare.
* Lägg till en gemensam notering - För att lägga till en notering till mer än en deltagare';
...
$string['writingblogsinfo'] = 'Skriver blogg info';
...
$string['xmldbeditor'] = 'Redigerare för XMLDB';
