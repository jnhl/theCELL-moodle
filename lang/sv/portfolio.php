...
/**
 * Strings for component 'portfolio', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   portfolio
...
$string['filedenied'] = 'Tillgång till denna fil nekad';
...
$string['selectedwait'] = 'Valda för att vänta?';
...
$string['sure'] = 'Är du säker på att du vill ta bort \'{$a}\'? Detta kan inte återställas.';
$string['transfertime'] = 'Överföringstid';
