...
/**
 * Strings for component 'glossary', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   glossary
...
$string['displayformat_help'] = 'Det finns 7 visningsformat: * Enkel ordboksstil – ingen författarinfo visas och bilagor visas som länkar. * Fortlöpande utan författare – bidrag visas ett efter ett utan några avskiljare förutom ikonerna för redigering.   * Komplett med författare  - ett forumliknande visningsformat som anger data om författaren och med bilagor som visas som länkar. * Komplett utan författare  - ett forumliknande visningsformat utan författare och med bilagor som visas som länkar. * Encyclopedia – samma som "Komplett med författare” med bifogade bilder som visas inline * Lista över bidrag – med begrepp som är förtecknade som länkar * FAQ – orden FRÅGA och SVAR är kopplade till begreppet respektive till dess definition.';
