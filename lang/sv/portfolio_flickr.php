...
/**
 * Strings for component 'portfolio_flickr', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['noauthtoken'] = 'Det gick inte att hämta någon "token" för autenticering för användning i den här sessionen.';
