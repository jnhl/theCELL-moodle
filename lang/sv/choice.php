...
/**
 * Strings for component 'choice', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   choice
...
$string['atleastoneoption'] = 'Du måste lägga till minst ett svarsalternativ.';
...
$string['publishafterclose'] = 'Visa resultaten för studenterna/eleverna/deltagarna/de lärande först efter det att opinionsundersökningen är avslutad';
$string['publishalways'] = 'Visa alltid resultaten för studenterna/eleverna/deltagarna/de lärande';
