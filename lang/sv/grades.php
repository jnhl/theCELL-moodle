...
/**
 * Strings for component 'grades', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   grades
...
$string['gradecategoryonmodform_help'] = 'Denna inställning avgör kategorin i vilken denna aktivitets betyg placeras i betygsboken.';
...
$string['showfeedback_help'] = 'Ska återkopplingskolumn visas?';
...
$string['showuseridnumber'] = 'Visa användarnas id-nummer';
$string['showuseridnumber_help'] = 'Detta avgör huruvida du vill visa användarnas ID-nummer i kompletterande kolumn.';
