...
/**
 * Strings for component 'repository', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   repository
...
$string['activerepository'] = 'Tillgängliga plugin-program för arkiv';
$string['activitybackup'] = 'Säkerhetskopiering av aktivitet';
$string['add'] = 'Lägg till';
$string['addfile'] = 'Lägg till...';
$string['addplugin'] = 'Lägg till plugin-program för arkiv';
$string['allowexternallinks'] = 'Tillåt externa länkar';
$string['areacategoryintro'] = 'Introduktion av kategori';
$string['areacourseintro'] = 'Introduktion av kurs';
...
$string['automatedbackup'] = 'Automatiska säkerhetskopior';
$string['back'] = '&laquo; Tillbaka';
$string['backtodraftfiles'] = '&laquo; Tillbaka till administration av filer innehållande utkast';
$string['cacheexpire'] = 'Tiden för lagring av cache går ut';
...
$string['createinstance'] = 'Skapa en instans av ett arkiv';
$string['createrepository'] = 'Skapa en instans av ett arkiv';
$string['createxxinstance'] = 'Skapa en "{$a}" instans ';
$string['date'] = 'Datum';
$string['deleted'] = 'Arkivet har tagits bort';
$string['deleterepository'] = 'Ta bort det här arkivet';
...
$string['editrepositoryinstance'] = 'Redigera instans av arkiv';
$string['emptylist'] = 'Tom lista';
$string['emptytype'] = 'Det går inte att skapa arkivtypen: typnamnet är tomt';
$string['enablecourseinstances'] = 'Tillåt användare att lägga till en instans av ett arkiv till kursen';
$string['enableuserinstances'] = 'Tillåt användare att lägga till en instans av ett arkiv till sammanhanget för användaren/na';
...
$string['existingrepository'] = 'Det finns redan ett sådant här arkiv';
...
$string['instances'] = 'Instanser av arkiv';
...
$string['invalidplugin'] = 'Ogiltigt plugin-program för arkiv';
$string['invalidrepositoryid'] = 'Ogiltigt ID för arkiv';
...
$string['login'] = 'Inloggning';
$string['logout'] = 'Logga ut';
$string['manage'] = 'Administrera arkiv';
...
$string['personalrepositories'] = 'Tillgängliga instanser av arkiv';
$string['plugin'] = 'Plugin-program för arkiv';
...
$string['repository'] = 'Arkiv';
$string['repositorycourse'] = 'Arkiv för kurser';
$string['save'] = 'Spara ';
...
$string['siteinstances'] = 'Instanser av arkiv på webbplatsen';
$string['size'] = 'Storlek';
...
$string['usercontextrepositorydisabled'] = 'Du kan inte redigera det här arkivet i sammanhanget för användare';
