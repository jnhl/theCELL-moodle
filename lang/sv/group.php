...
/**
 * Strings for component 'group', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   group
...
$string['enrolmentkey_help'] = 'En nyckel för registrering möjloggör att åtkomst till kursen begränsas till endast de som känner till denna nyckel. Om en gruppnyckel för registrering är specificerad kommer användandet av denna nyckel släppa in användaren i kursen samt automatiskt göra denna till medlem av gruppen som nyckeln hör till.';
...
$string['groupmembersonly_help'] = 'Om denna kryssruta är förbockad kommer aktiviteten (eller resursen) bara vara tillgänglig för elever som är medlemmar i grupper inom den valda grupperingen.';
...
$string['groupmodeforce_help'] = 'Om framtvinga gruppläge är valt kommer kursens gruppläge att appliceras på alla aktiviteter i kursen. Gruppinställningar för enskild aktivitet kommer då att ignoreras.';
...
$string['importgroups_help'] = 'Grupper kan importeras via textfil. Formatet för filen ska vara enligt följande:

* Varje rad i filen innehåller en post
* Varje post är en serie av data separerade med kommatecken
* Första posten innehåller en lista över fältnamn som definierar formatet för resten av filen
* Nödvändiga fältnamn är gruppnamn
* Valbara fältnamn är beskrivning, nyckel för registrering, bild, dölj bild';
...
$string['namingscheme_help'] = 'Symbolen snabel a (@) kan användas för att skapa grupper med namn som innehåller bokstäver. Till exempel kommer Grupp @ generera grupper med namn Grupp A, Grupp B, Grupp C, .....

Symbolen nummertecken (#) kan användas för att skapa grupper med namn som innehåller siffror. Till exempel kommer Grupp # att skapa grupper med namn Grupp 1, Grupp 2, Grupp 3, ...';
