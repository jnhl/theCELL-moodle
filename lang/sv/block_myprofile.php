...
/**
 * Strings for component 'block_myprofile', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['display_firstaccess'] = 'Visa första åtkomst';
$string['display_icq'] = 'Visa ICQ';
$string['display_institution'] = 'Visa institution';
$string['display_lastaccess'] = 'Visa senaste åtkomst';
$string['display_lastip'] = 'Visa senaste IP';
$string['display_msn'] = 'Visa MSN';
$string['display_phone1'] = 'Visa tfn nr 1';
$string['display_phone2'] = 'Visa tfn nr 2';
