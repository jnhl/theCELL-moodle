...
/**
 * Strings for component 'block_community', language 'sv', branch 'MOODLE_20_STABLE'
 *
...
$string['addcommunitycourse'] = 'Lägg till en gemensamhetskurs';
...
$string['coursedesc'] = 'Beskrivning';
$string['courselang'] = 'Språk';
$string['coursename'] = 'Namn';
$string['courses'] = 'Kurser';
$string['coverage'] = 'Taggar: {$a}';
$string['donotrestore'] = 'Nej';
$string['dorestore'] = 'Ja';
...
$string['language_help'] = 'Du kan söka efter kurser som är skrivna på ett specifikt språk.';
$string['licence'] = 'Licens';
$string['moredetails'] = 'Fler detaljer';
$string['mycommunities'] = 'Mina gemenskaper:';
$string['next'] = 'Nästa>>>';
$string['nocomments'] = 'Inga kommentarer';
$string['nocourse'] = 'Det fanns inga kurser';
...
$string['orderbyratingaverage'] = 'Betygssättning/omdömen';
$string['outcomes'] = 'Resultat: {$a}';
$string['pluginname'] = 'Sökning av gemenskaper';
$string['rateandcomment'] = 'Bedöm och kommentera';
...
$string['visitsite'] = 'Besök webbplats';
