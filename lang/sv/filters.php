...
/**
 * Strings for component 'filters', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   filters
...
$string['applyto'] = 'Tillämpa på';
$string['categoryrole'] = 'Roll för kategori';
...
$string['includenever'] = 'Aldrig medtagen';
...
$string['nevermodified'] = 'Aldrig ändrad';
$string['newfilter'] = 'Nytt filter';
$string['nofiltersenabled'] = 'Inga filterplugins har aktiverats på denna webbplats.';
$string['off'] = 'Av';
