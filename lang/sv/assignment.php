...
/**
 * Strings for component 'assignment', language 'sv', branch 'MOODLE_20_STABLE'
 *
 * @package   assignment
...
$string['enableemailnotification_help'] = '<p>Om du aktiverar detta så kommer studenterna/eleverna/deltagarna/de lärande att få meddelanden via e-post angående sina betyg och återkoppling.</p>
...
$string['feedbackfromteacher'] = 'Återkoppling från {$a}';
